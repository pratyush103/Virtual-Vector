				...
				if results.multi_hand_landmarks:				 
					...
					for hand_landmarks in results.multi_hand_landmarks: 
						mp_drawing.draw_landmarks(image, 
								...
								landmark_drawing_spec=mp_drawing.DrawingSpec(color=get_tip_color()),
								connection_drawing_spec=mp_drawing.DrawingSpec(color=get_hand_color())) 
				else: 
